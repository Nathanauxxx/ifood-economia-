describe('Teste do Painel: Evoluções Médicas IOT', () => {
  ...
  beforeEach(() => {
    ...
    cy.loginSeguroPainel({
      ...
      loginUrl: 'http://sistemashchomolog.phcnet.usp.br/Conta/Login?returnUrl=http%3A%2F%2Fpainelmvhomolog.phcnet.usp.br%2FPainelEvolucoesMedicasIOT%2F'
    });
  });
  ...
  it('Deve preencher os filtros e interagir com os botões', () => {
    cy.log('Iniciando automação do Painel Evoluções Médicas IOT...');
    ...
    cy.log('Automação do painel Evoluções Médicas IOT concluída com sucesso!');
  });
});
