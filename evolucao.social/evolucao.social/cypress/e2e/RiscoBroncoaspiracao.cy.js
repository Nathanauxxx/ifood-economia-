describe('Teste do Painel: Pacientes com Risco de Broncoaspiração', () => {

  beforeEach(() => {
    // Faz o login e entra direto no painel
    cy.loginSeguroPainel({
      painelUrl: 'http://painelmvhomolog.phcnet.usp.br/PainelRiscoBroncoAsp'
    });
  });
  ...
  it('Deve preencher os filtros e interagir com os botões', () => {
    cy.log('Iniciando automação do Painel Risco de Broncoaspiração...');
